...
class Npl:
    ...
    def minimise_MMD(self, data, weights, key, Nstep=1000, eta=0.01, batch_size=10):
        ...
        def obj_fun(theta, x, n, key):
            y = self.model.sample(theta, key)  # Returnes self.m random samples from the model with parameter theta
        ...
        return jnp.exp(best_theta) # rate parameter of expoenential model is re-parametrised to ensure positivity
